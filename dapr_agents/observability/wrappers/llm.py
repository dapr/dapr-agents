...
class LLMWrapper:
    ...
    def _build_llm_attributes(self, wrapped: Any, instance: Any, args: Any, kwargs: Any) -> Dict[str, Any]:
        """
    ...
    def _extract_template_info(self, prompt_template: Any, instance: Any) -> Dict[str, Any]:
        """
        ...
        """
        template_info = {}
        template_info['type'] = getattr(prompt_template, 'template_format', getattr(instance, 'template_format', None))
        ...
        if hasattr(prompt_template, 'model_dump') and callable(prompt_template.model_dump):
            template_info.update(prompt_template.model_dump())
            
        return template_info
    
    def _handle_async_execution(self, wrapped: Any, args: Any, kwargs: Any, attributes: Dict[str, Any]) -> Any:
        """
        ...
        async def async_wrapper():
            with self._tracer.start_as_current_span("ChatCompletion", attributes=attributes) as span:
                try:
    ...
    def _handle_sync_execution(self, wrapped: Any, args: Any, kwargs: Any, attributes: Dict[str, Any]) -> Any:
        """
    ...
    def _set_message_attributes(self, span: Any, message: Any) -> None:
        ...
        """
        logger.debug(f"Setting output message attributes for role: {getattr(message, 'role', 'assistant')}")
